...
class HandlingsView extends AdminView{
  ...
  function table (){
    ...
    echo "<tr  class='admin_list_header'>";
      ...
      echo "<th>".con('fees')."</th>";
      echo "<th align='center' width='40'>".con('handling_www','Web')."</th>";
      echo "<th align='center' width='40'>".con('handling_sp','POS')."</th>";
      echo "<th>&nbsp;</th>";
    echo "</tr>\n";
...
//				 	echo "<td class='admin_list_item' colspan=3>&nbsp;</td>";
  ...
  function form ($data, $err, $title){
      ...
      echo "<tr ><td colspan='2' class='admin_name'>" . con('hanging_email_settings') ."</td></tr>";
  		$this->print_select_tpl('handling_email_template_ord',"'email','swift'",$data,$err, true, false);
