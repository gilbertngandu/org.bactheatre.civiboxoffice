...
class ctrlControlMain extends ctrlAdminMain {
  ...
  function loadMenu(){
      $this->addACLs(array('control_admin|control',
                           'search_admin|control',
                           'orders_admin|control',
                           'users_admin|control'),true);
  ...
  function drawOrganizer(){
    ...
    echo "
      ...
      <li><a class='link_head' href='view_search.php'>" . con('search')."</a></li>
      <li><a class='link_head' href='?action=logout'>" . con('logout') . "</a>&nbsp;&nbsp;</td></li>
    </ul>
    ";
  }
}
