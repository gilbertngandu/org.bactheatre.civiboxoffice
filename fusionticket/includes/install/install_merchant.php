...
class install_merchant  {
  ...
  static function postcheck($Install) {
    if (empty($_POST['organizer_name'])) { addError('organizer_name','Mandatory'); }
    if (empty($_POST['organizer_email'])) { addError('organizer_email','Mandatory'); }
    Install_Request(array('organizer_name','organizer_address', 'organizer_plz', 'organizer_ort', 'organizer_state', 'organizer_country',
                          'organizer_phone','organizer_fax', 'organizer_currency', 'organizer_email'),'CONFIG');
    return !hasErrors();
  }
...
";
    ...
    AdminView::print_input('organizer_name'   ,$_SESSION['CONFIG'], $err,25,100);
    AdminView::print_input('organizer_address',$_SESSION['CONFIG'], $err,25,100);
    AdminView::print_input('organizer_plz'    ,$_SESSION['CONFIG'], $err,25,100);
    AdminView::print_input('organizer_ort'    ,$_SESSION['CONFIG'], $err,25,100);
    AdminView::print_input('organizer_state'  ,$_SESSION['CONFIG'], $err,25,100);
    AdminView::print_countrylist('organizer_country', $_SESSION['CONFIG'], $err);
    AdminView::print_input('organizer_phone'  ,$_SESSION['CONFIG'], $err,25,100 );
    AdminView::print_input('organizer_fax'    ,$_SESSION['CONFIG'], $err,25,100 );
    AdminView::print_input('organizer_email'  ,$_SESSION['CONFIG'], $err,25,100 );
    AdminView::print_input('organizer_currency',$_SESSION['CONFIG'], $err,4,3 );
    echo " </table>";
