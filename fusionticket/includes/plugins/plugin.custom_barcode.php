 ...
 *
 *
 * @version $Id: plugin.custom_barcode.php 1824 2012-07-14 22:14:35Z nielsNL $
 * @copyright 2010
 */
class plugin_custom_barcode extends baseplugin {
  ...
  function doOrderencodebarcode($order, $ticket, $barcode) {
    return str_pad(base_convert($barcode,10,16), 10, "0", STR_PAD_LEFT);
  }
