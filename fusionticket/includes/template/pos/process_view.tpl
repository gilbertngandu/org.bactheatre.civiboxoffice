 ...
 * clear to you.
 *}<!-- $Id: process_view.tpl 1788 2012-05-12 11:14:15Z nielsNL $ -->
...
<br />
  <table width='100%' border='0'>
          ...
          <table width='99%' border='0'>
              ...
              <tr>
                  ...
                  <form name='manualpayment' action='view.php' method='post'>
                    <input type="hidden" name="action" value="setpaid" />
        						<input type="hidden" name="order_id" value="{$shop_order.order_id}" />
                    <input type="submit" value="{!change_order_to_paid!}" onclick="if(alert("{!change_order_to_paid_confirm!}")){ return true }else{ return false }" />
                  </form>
                </td>
              </tr>
            {/if}
            ...
            {* Old paid method..}
       			{if ($shop_order.order_status neq "res") and
       			    ($shop_order.order_status neq "cancel") and
      				  ($shop_order.order_payment_status eq "none") and
      				  ($shop_order.order_payment_status neq "pending") and
      				  ($shop_order.handling_payment neq 'entrance')}
        			<tr>
        				<td colspan="2">
    ...
    {* nclude file="view_notes.tpl" order=$shop_order *}
  </table>
<br />
