 ...
 * clear to you.
 *}<!-- $Id: cart_view_block.tpl 1844 2012-07-31 08:41:01Z nielsNL $ -->
    ...
    <div class="art-box art-blockcontent">
      <div class="art-box-body art-blockcontent-body">
    	  ...
    	  {else}
            ...
            {gui->button url='index.php?action=view_cart' name='view_order' type=1}
            {if $cart_overview.valid}
      			   {ShowFormToken name='ReservHandling'}
               {gui->button url='submit' name='checkout' type=1}
            {/if}
    			</form>
      	{/if}
