 ...
 * clear to you.
 *}<!-- $Id: event_ordering.tpl 1841 2012-07-30 20:14:32Z nielsNL $ -->
    ...
    <table width="100%" cellpadding='2' cellspacing='2' bgcolor='white' >
      <tbody>
        ...
        <tr id='discount-name'>
          ...
          <td class='user_value'>
            {discount all='on' event_id=$shop_event.event_id  category_id=$category_id cat_price=$shop_category.category_price}{/discount}
