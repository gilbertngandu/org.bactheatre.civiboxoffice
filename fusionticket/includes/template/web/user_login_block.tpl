 ...
 * clear to you.
 *}<!-- $Id: user_login_block.tpl 1824 2012-07-14 22:14:35Z nielsNL $ -->
                                ...
                                <div>
                                  <form action="{$_SHOP_root}index.php" id='login-form' name='' method='post' class='loginform' enctype='application/x-www-form-urlencoded'>
                                    ...
                                    <p id="form-login-username">
                                      ...
                                      <input type='input' id="modlgn-username" name='username' size='25' validate='required:true'> {printMsg key='loginusername'}
                                  	</p>
                                  	<p id="form-password-remember">
                                  		<label for="modlgn-passwd">{!password!}</label><br>
                                      <input id="modlgn-passwd" type='password' name='password' size='25' validate='required:true'>{printMsg key='loginpassword'}
                                    </p>
